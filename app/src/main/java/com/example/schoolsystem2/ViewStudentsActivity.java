...
public class ViewStudentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set listeners to reload students when spinner selection changes
    ...
    private void loadGradeLevels() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, URL_GRADE_LEVEL, null,
                response -> {
                    ...
                    gradeLevelMap.clear();
                    gradeLevelNames.add("All"); // Option to select all
                ...
                response -> {
                    try {
                        ...
                        for (int i = 0; i < studentsArray.length(); i++) {
                            ...
                            studentsList.add(new Student(id, name, gender, dob, gradeLevel, className, contact));
                        }
